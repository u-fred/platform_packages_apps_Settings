...
public class ChooseBiometricSecondFactorPin extends SettingsActivity {
    ...
    static final String EXTRA_KEY_PRIMARY_CREDENTIAL = "primary_credential";
    ...
    public static class IntentBuilder {
        ...
        public Intent build() {
            if (mIntent.hasExtra(Intent.EXTRA_USER_ID)
                    && mIntent.hasExtra(EXTRA_KEY_PRIMARY_CREDENTIAL)) {
                return mIntent;
            }
            throw new IllegalArgumentException("Must set all mandatory fields!");
        }
    }
    ...
    public static class ChooseBiometricSecondFactorPinFragment extends InstrumentedFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            extras.getInt(Intent.EXTRA_USER_ID, -1);
