...
/**
 * Controller for deleting their biometric second factor PIN with a confirmation dialog.
 */
public class DeleteBiometricSecondFactorPinPreferenceController extends BasePreferenceController {
    ...
    public void onBiometricSecondFactorPinDeleteConfirmed() {
        mLockPatternUtils.setLockCredential(
                LockscreenCredential.createNone(), mPrimaryCredential, mUserId);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        DeleteBiometricSecondFactorPinConfirmationDialog.newInstance(
                R.string.delete_biometric_second_factor_pin_dialog_title,
                R.string.delete_biometric_second_factor_pin_dialog_message)
    ...
    public static class DeleteBiometricSecondFactorPinConfirmationDialog
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton(
                            R.string.delete_biometric_second_factor_pin_dialog_positive_button,
